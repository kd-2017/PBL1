...
<html lang="ja">
  ...
  <body>
    ...
    <div class="container">
        <div class="row">
            <form action="change2.php" method="post" name="date">
            <div class="col-sm-3 col-sm-offset-3">
                <div class="form-group">
                <label for="modify" class="control-label">１日のみ変更</label>
                    <div class='input-group date' id='datetimepicker1'>
                        <input type='text' name="modify" id="modify" placeholder="変更する日を入力" class="form-control" />
          ...
          <form action="change.php" method="post" name="date">
            <div class= "col-md-3">
                  <div class="form-group">
                  <label for="form" class="control-label">期間を指定して変更</label>
                      <div class='input-group date' id='datetimepicker1'>
                          <input type='text' name="form" id="form" placeholder="変更する日を入力" class="form-control" />
                          <span class="input-group-addon">
                              <span class="glyphicon glyphicon-calendar"></span>
                          </span>
                      </div>
                  ...
                  <div class="form-group">
                  <label for="to" class="control-label"></label>
                      <div class='input-group date' id='datetimepicker2'>
                          <input type='text' name="to" id="to" placeholder="変更する日を入力" class="form-control" />
                          <span class="input-group-addon">
                              <span class="glyphicon glyphicon-calendar"></span>
                          </span>
                      </div>
